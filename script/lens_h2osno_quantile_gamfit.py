...
phisfl = 'b.e11.B20TRC5CNBDRD.f09_g16.001.cam.h0.PHIS.185001-200512.nc'
...
pltnm = 'LENS_H2OSNO_SWEGammaShape_NAmer_%d.pdf' % (tgtdt)
pyplot.tight_layout()
pyplot.savefig(pltnm)
pyplot.close()
...
pltnm = 'LENS_H2OSNO_SWEGammaScale_NAmer_%d.pdf' % (tgtdt)
pyplot.tight_layout()
pyplot.savefig(pltnm)
pyplot.close()
...
pltnm = 'LENS_H2OSNO_SfcGeopHt_NAmer_%d.pdf' % (tgtdt)
pyplot.tight_layout()
pyplot.savefig(pltnm)
pyplot.close()
...
pltnm = 'LENS_H2OSNO_MeanVar_NAmer_%d.pdf' % (tgtdt)
#pyplot.tight_layout()
pyplot.savefig(pltnm)
pyplot.close()
...
pltnm = 'LENS_H2OSNO_Q95Pairs_NAmer_%d.pdf' % (tgtdt)
#pyplot.tight_layout()
pyplot.savefig(pltnm)
pyplot.close()
...
pltnm = 'LENS_H2OSNO_Q50Pairs_NAmer_%d.pdf' % (tgtdt)
#pyplot.tight_layout()
pyplot.savefig(pltnm)
pyplot.close()
